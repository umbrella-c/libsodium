...
IF(HAVE_AVX512FINTRIN_H)
    SET(AVX_DEFINITIONS "${AVX_DEFINITIONS} -DHAVE_AVX512FINTRIN_H")
    IF(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUC OR CMAKE_C_COMPILER_ID MATCHES "Clang")
...
IF(HAVE_AVX2INTRIN_H)
    SET(AVX_DEFINITIONS "${AVX_DEFINITIONS} -DHAVE_AVX2INTRIN_H")
    IF(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUC OR CMAKE_C_COMPILER_ID MATCHES "Clang")
...
IF(HAVE_AVXINTRIN_H)
    SET(AVX_DEFINITIONS "${AVX_DEFINITIONS} -DHAVE_AVXINTRIN_H")
    IF(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUC OR CMAKE_C_COMPILER_ID MATCHES "Clang")
